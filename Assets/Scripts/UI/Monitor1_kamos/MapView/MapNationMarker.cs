...
public class MapNationMarker : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    static MapNationMarker() 
    {
        ...
        //Dictionary<AreaType, string> rawSpriteSets = new() {
        //    { AreaType.Nuclear, "Image/Icon_Power.png"},
        //    { AreaType.Ocean,   "Image/Icon_Ocean.png"},
        //};
    ...
    private void OnValidate()
    {
        ...
        imageIcon.sprite = areaType == AreaType.Ocean? oceanSprite:nuclearSprite;// areaSpriteDic[areaType];
    ...
    public void SetAreaData(int areaId, string areaName, AreaType areaType, ToxinStatus status)
    {
        this.areaId = areaId;
